...
@Component({
  selector: 'app-monprofil-creation',
  templateUrl: './monprofil-creation.page.html',
  styleUrls: ['./monprofil-creation.page.scss'],
})
export class MonprofilCreationPage implements OnInit {
